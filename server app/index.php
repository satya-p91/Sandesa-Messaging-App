...
<html>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                function getChatroomMessages(id) {
                    $.getJSON("v1/index.php/chat_rooms/" + id, function (data) {
                        var li = '';
                ...
                $('#send_to_topic').on('click', function () {
                    ...
                    $.post("v1/index.php/chat_rooms/" + $(this).attr('chat_room') + '/message',
    ...
    <body>
        <div class="header">
            <label class="logo">Forgottenbit.online</label>
            <h2>firebase Cloud Messaging</h2>
            <h2 class="small">Sending push notifications on Android</h2>
        </div>
        <div class="container_body">
            <div class="topics">
                <h2 class="heading">Download & Install the  chatting app</h2>
                Download & Install the chatting api <a href="#">apk</a> before trying the<br/><br/>Once installed, refresh this page 
